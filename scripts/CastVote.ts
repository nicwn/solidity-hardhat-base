...
async function main() {
  ...
  const contractAddress = parameters[0] as `0x${string}`; // Pass in this contract: 0x360f32f4a03e819394fed4e90b78cfe332277d52
  ...
  // Create Public Client and Wallet Client
